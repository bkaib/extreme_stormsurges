def run(season, predictor, timelag_, percentile, station_names, run_id, model_run):
    # Modules
    import numpy as np
    import xarray as xr
    import pandas as pd
    ...
    #---
    ndim = t_predictor.shape[0]
    X = X_timelag.reshape(ndim, -1) # (ndim, nclasses)
    ...
    fig = evaluation.importance_map(importance, lons, lats, tflag)
